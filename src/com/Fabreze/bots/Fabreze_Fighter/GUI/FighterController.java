package com.Fabreze.bots.Fabreze_Fighter.GUI;

import com.Fabreze.bots.Fabreze_Fighter.FighterMain;
import com.Fabreze.bots.JSON;
...
public class FighterController implements Initializable {
    ...
    private FighterMain bot;

    public FighterController(FighterMain bot){
        this.bot = bot;
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cbloot.setOnAction(e -> {
            bot.cbloot = cbloot.isSelected();
        });
        outofpot.setOnAction(e -> {
            bot.bankpot = outofpot.isSelected();
            if (!fullinvbank.isSelected() && !outoffoodbank.isSelected()){
        ...
        save.setOnAction(e -> {
            ...
            saveprofile.put("lootpostcb", bot.cbloot);
        ...
        loadsave.setOnAction(e -> {
            ...
            try {
                ...
                bot.cbloot = (boolean) saveprofile.get("lootpostcb");
