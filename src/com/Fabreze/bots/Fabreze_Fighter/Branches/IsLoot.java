package com.Fabreze.bots.Fabreze_Fighter.Branches;

import com.Fabreze.bots.Fabreze_Fighter.FighterMain;
import com.Fabreze.bots.Fabreze_Fighter.Leaves.GrabLoot;
...
public class IsLoot extends BranchTask {
    ...
    public boolean validate(){
        if (bot.cbloot){//If 'Only Loot When Not in Combat' is selected, puts loot check after combat check
            return false;
        }
        else {
