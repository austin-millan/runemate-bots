package com.Fabreze.bots.Fabreze_Fighter.Branches.Banking;

import com.Fabreze.bots.Fabreze_Fighter.FighterMain;
import com.Fabreze.bots.Fabreze_Fighter.Leaves.Bank.GrabItems;
...
public class IsPotOut extends BranchTask {
    ...
    private IsAtFightLoc isAtFightLoc = new IsAtFightLoc();
    ...
    @Override
    public TreeTask failureTask() { return isAtFightLoc; }
