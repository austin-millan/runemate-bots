package com.Fabreze.bots.Fabreze_Agility.GUI;

import com.Fabreze.bots.Fabreze_Agility.Canifis.Branches.IsOnRoof1;
import com.Fabreze.bots.Fabreze_Agility.Draynor_Village.Branches.IsAtStart;
import com.Fabreze.bots.Fabreze_Agility.MarksOfGrace.IsHealthLow;
import com.Fabreze.bots.Fabreze_Agility.Fabreze_Agility_Main;
import com.Fabreze.bots.Fabreze_Agility.Gnome_Stronghold.Branches.IsRunEnabled;
import com.Fabreze.bots.Fabreze_Agility.Varrock.Branches.IsAtClothesLine;
...
public class Fabreze_AgilityController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        course.setItems(FXCollections.observableArrayList(new Course(new IsRunEnabled(),"Gnome Stronghold"),
                                                          new Course(new IsHealthLow(new IsAtStart()), "Draynor Village"),
                                                          new Course(new IsHealthLow(new com.Fabreze.bots.Fabreze_Agility.Al_Kharid.Branches.IsAtStart()), "Al Kharid"),
