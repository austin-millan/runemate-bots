package com.Fabreze.bots.Fabreze_Cannoner.Leaves.Bank;
...
public class MoveToCannonLoc extends LeafTask {
    ...
    public void execute(){
        ...
        WebPath path = Traversal.getDefaultWeb().getPathBuilder().buildTo(bot.cannon);
